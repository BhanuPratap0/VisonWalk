...
public class SetNavigationTarget : MonoBehaviour {
    ...
    private void SetNavigationTargetDropDownOptions(int floorNumber) {
        ...
        if (floorNumber == 1) {
            navigationTargetDropDown.options.Add(new TMP_Dropdown.OptionData("Entrance "));
            navigationTargetDropDown.options.Add(new TMP_Dropdown.OptionData("ComputerCenter"));
            navigationTargetDropDown.options.Add(new TMP_Dropdown.OptionData("CseHodRoom"));
        }
        if (floorNumber == 2) {
            navigationTargetDropDown.options.Add(new TMP_Dropdown.OptionData("SecondEntrance"));
            navigationTargetDropDown.options.Add(new TMP_Dropdown.OptionData("DKSirRoom"));
        }
    }
}