...
using ZXing;
using UnityEngine.XR.ARFoundation;
using UnityEngine.XR.Management; // You may need this depending on your setup
using Unity.XR.CoreUtils; // XROrigin is part of this namespace
...
public class QrCodeRecenter : MonoBehaviour {
    ...
    //         SetQrCodeRecenterTarget("Entrance");
    //     }
    // }
    ...
    private void SetQrCodeRecenterTarget(string targetText) {
        Target currentTarget = navigationTargetObjects.Find(x => x.Name.ToLower().Equals(targetText.
        ToLower()));
